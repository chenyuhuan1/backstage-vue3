import { defineComponent, ref, watch, createVNode, resolveComponent, mergeProps, createTextVNode } from 'vue';
import { d as dayjs } from './dayjs.min-d3ad2899.js';
...
var dateRange = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      ...
      var formItem = CustomDynamicComponent.language === CustomDynamicComponent.antLanguage ? createVNode(resolveComponent("a-form-item"), null, null) : createVNode("template", null, null);
      return createVNode("div", {
        "class": ['BsDateRange', styles.width100],
        "style": {
          display: 'flex'
        }
      ...
      }, props.config.nativeProps), null), createVNode("span", {
        "style": "padding: 0 5px;"
      }, [createTextVNode("~")]), createVNode(formItem, {
        "style": "margin: 0;flex: 1;display: flex;"
      }, {
        default: function _default() {
          return [createVNode(dynamicDatePicker, mergeProps({
            "style": {
              flex: 1
            },
...
export { dateRange as d };
//# sourceMappingURL=BsDateRange-986aa6cc.js.map
