...
var asyncToGenerator = require('../chunkFile/asyncToGenerator-12caf45d.js');
var objectSpread2 = require('../chunkFile/objectSpread2-6fc8a74b.js');
var toConsumableArray = require('../chunkFile/toConsumableArray-5cac386d.js');
var vue = require('vue');
var CustomDynamicComponent = require('../chunkFile/CustomDynamicComponent-2e7e5e9c.js');
...
var table = vue.defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var changeTableColumns = function changeTableColumns(data) {
      var arr = toConsumableArray._toConsumableArray(data);
     ...
     * @param data columns数据
     */
    var cloneTableConfig = vue.reactive(objectSpread2._objectSpread2(objectSpread2._objectSpread2({}, defaultTableConfig), props.tableConfig));
    vue.watch(function () {
    ...
    var clonePagingConfig = vue.reactive(objectSpread2._objectSpread2(objectSpread2._objectSpread2({}, defaultPagingConfig), props.pagingConfig));
    vue.watch(function () {
    ...
    return function () {
      ...
      return vue.createVNode("div", {
        ...
        default: function _default() {
          return [CustomDynamicComponent.CustomDynamicComponent.language === CustomDynamicComponent.CustomDynamicComponent.eleLanguage ? vue.createVNode(vue.Fragment, null, [cloneTableConfig.rowSelection && cloneTableConfig.rowSelection.type === 'checkout' ? vue.createVNode(dynamicTableColumn, {
            "type": "selection",
            "align": "center",
