...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        <dynamicInput class="input" type='text' model-value={props.modelValue} placeholder={props.config.placeholder || `请输入${props.config?.label ?? ''}`} disabled={!!props.config.disabled} 
...
//# sourceMappingURL=BsInput.jsx.map