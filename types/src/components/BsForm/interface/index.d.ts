...
/** 所有表单控件的联合类型 */
export declare type columnsBase = 
/** 输入框控件 */
inputProps
/** 密码输入控件 */
 | passwordProps
...
export declare type format = (item: any) => any;
/** 输入框控件props */
...
export interface selectProps extends defaultProps {
    ...
    remote?: boolean;
    /** 远程搜索函数 */
    remoteMethod?: (query: string) => Promise<{
        [label: string]: any;
    }[]>;
    /** 多选开关 */
    multiple?: boolean;
...
export declare type inlayRuleType = {
    validatorName: keyof rulesIn;
    message?: string;
    trigger?: string;
};
export {};
