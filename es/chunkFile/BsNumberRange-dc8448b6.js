...
var numberRange = defineComponent({
  name: 'BsNumberRange',
  props: {
    modelValue: {
      type: [String, Number],
  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      ...
      return createVNode("div", {
        "class": ['BsNumberRange', styles.width100, styles.BsNumberRange]
        ...
        default: function _default() {
          return [createVNode(dynamicNumber, mergeProps({
            "style": {
              flex: 1
            },
...
export { numberRange as n };
//# sourceMappingURL=BsNumberRange-dc8448b6.js.map
